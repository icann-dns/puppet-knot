...
# @param default_refresh_min_interval Minimum refresh interval
# @param default_refresh_max_interval Maximum refresh interval
# @param default_retry_min_interval Minimum retry interval
# @param default_retry_max_interval Maximum retry interval
# @param default_expire_min_interval Minimum expire interval
# @param default_expire_max_interval Maximum expire interval
class knot (
  ...
  Optional[Integer[1]]             $default_refresh_min_interval = undef,
  Optional[Integer[1]]             $default_refresh_max_interval = undef,
  Optional[Integer[1]]             $default_retry_min_interval   = undef,
  Optional[Integer[1]]             $default_retry_max_interval   = undef,
  Optional[Integer[1]]             $default_expire_min_interval  = undef,
  Optional[Integer[1]]             $default_expire_max_interval  = undef,
) {
